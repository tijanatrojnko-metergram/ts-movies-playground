...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/createMovie',
            ...
            const args = {
                    movie: {"in":"body","name":"movie","required":true,"ref":"IMovie"},
            };
        ...
        app.get('/movies/:movieId',
            ...
            try {
              ...
              const promise = controller.readMovieWithId.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.put('/updateMovie',
            ...
            const args = {
                    movie: {"in":"body","name":"movie","required":true,"dataType":"intersection","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"id":{"dataType":"string","required":true}}},{"ref":"IMovie"}]},
            };
